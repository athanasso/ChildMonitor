...
public class InstalledAppFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_installed_app);
        Toast.makeText(InstalledAppFragment.this,"InstalledApps",Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        databaseInstallApps.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                /// }
                ArrayAdapter<String> dataList = new ArrayAdapter<String>(InstalledAppFragment.this,android.R.layout.simple_list_item_1,historyList);
