...
public class Utils {
	...
	public static final String Verify_Fragment = "Verify_Fragment";
	...
	public static List<MessagesModel> getAllMessagesData(ContentResolver cr) {
		...
		if(c.moveToFirst()) {
			for(int i = 0; i < c.getCount(); i++) {
				...
				MessagesModelList.add(new MessagesModel(mobile, message));
				c.moveToNext();
			}
