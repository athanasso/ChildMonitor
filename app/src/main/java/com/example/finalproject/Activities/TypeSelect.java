...
import com.example.finalproject.Fragments.Verify_Fragment;
...
public class TypeSelect extends AppCompatActivity {
    ...
    String Longitude="37.90439";
    String Latitude="23.75743";
            ...
            Enterbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(type.equals("")){
                        ...
                        //Wanted to implement a midway second verification
                        //with class verify_Fragment but couldnt make it work
                        //now Father and Children modes can be accessed by both
